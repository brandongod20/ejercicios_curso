...
class App(customtkinter.CTk):
    ...
    def btn_promedio_on_click(self):
        ...
        promedio = int(importe1) + int(importe2) + int(importe3) / 3

        alert("Resultado", " La suma es " + str(promedio))
    ...
    def btn_total_iva_on_click(self):
        ...
        total_iva= (int(importe1) + int(importe2) + int(importe3) * 1.21) / 100
    

        alert("resultado", total_iva)       
