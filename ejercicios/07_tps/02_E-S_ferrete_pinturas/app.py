...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        convertir_c_f = (int(temperaturaC) * 9/5) + 32

        alert(title="La conversion",message="centigrados " + "a " + "Fahrenheit: " + str(convertir_c_f) )

    def btn_convertir_f_c_on_click(self):
      #(0 °F − 32) × 5/9 = -17,78 °C  
      temperaturaF = self.txt_temperatura_f.get()
      
      convertir_f_c = (int(temperaturaF)-32) * 5/9

      alert(title="La conversion",message="Fahrenheit" + "a " + "Centigrados: " + str(convertir_f_c) )
